...
| P1 | Pushed / rereview pending | Intentional `1.0.9` Git handoff | Release recovery commit `1ebd785` and results commit `080b8ea` are on `origin/main`. Rerun Claude review; tagging remains separately gated. |
